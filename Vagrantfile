...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  GO_VERSION = "go1.4rc2"
  config.vm.provision "shell", inline: "rm -rf go* && wget -q -O go.linux-amd64.tar.gz https://storage.googleapis.com/golang/"+GO_VERSION+".linux-amd64.tar.gz && tar zxf go.linux-amd64.tar.gz" 
  config.vm.provision "shell", inline: "PS1='$ ' source .bashrc && go get github.com/atotto/gomacs"
end
